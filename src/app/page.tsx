  ...
  return (
    <div className="space-y-4">
      ...
      <section className="bg-white shadow-sm"><div className="max-w-7xl mx-auto px-4 py-8"><div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div className="flex flex-col items-center text-center"><div className="text-3xl mb-2">🚚</div><h3 className="text-sm font-semibold text-gray-800">Free Delivery</h3><p className="text-xs text-gray-500 mt-1">On orders above ৳1,000</p></div>
