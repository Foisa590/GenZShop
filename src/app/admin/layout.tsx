...
import { LayoutDashboard, Package, ShoppingBag, Users, Settings, Menu, X, Store, BarChart3 } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md text-center">
          ...
          <p className="text-sm text-gray-500 mb-1">You don&apos;t have admin privileges.</p>
          <p className="text-xs text-gray-400 mb-4">আপনার অ্যাডমিন অ্যাক্সেস নেই</p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-left">
            <p className="text-xs font-semibold text-blue-900 mb-1">To grant admin access:</p>
            <p className="text-xs text-blue-700">Run this in Supabase SQL Editor:</p>
